    ...
    return (
        <div>
            <nav className="fixed left-0 right-0 top-4 z-50">
                {/* Desktop Menu */}
                <div className="mx-auto hidden max-w-2xl items-center justify-center rounded-lg border border-stone50/30 bg-black/20 py-3 background-blur-lg lg:flex">
                ...
                <div className="rounded-lg backdrop-blur-md lg:hidden">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <button className="focus:outlie-none lg-hidden" onClick={toggleMobileMenu}>
                                {isMobileMenuOpen ? (
